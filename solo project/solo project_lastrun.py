...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Vishwa Kotak\\Desktop\\Psychology courses\\PSY 310\\solo project\\solo project_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text="Welcome!\n\nThis experiment will be divided into 2 phases. Phase 1 will be followed with 'Spot the difference' and Phase two will be followed by Object Hide-n-seek'. These images would be followed by questions regarding the same. So make sure that you look at the picture intently.\n\nIf you agree to be a part of this experiment further, please press the 'Spacebar'. If you wish to not be a part of the experiment, please press the 'esc' key.\n\nThank you!",
        font='Arial',
    ...
    text_3 = visual.TextStim(win=win, name='text_3',
        text="PHASE 1\n\nIn this part of the experiment, you will be presented with images and you need detect on how many differences you were able to find. You will be under a time limit of 15 seconds. Answer truthfully and honestly. To start, please press the 'Spacebar'.\n\nALL THE BEST!",
        font='Arial',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='How many differences did you spot? \n(Range 1-9)',
        font='Arial',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_4 = visual.TextStim(win=win, name='text_4',
        text="Phase 1 of the experiment has ended. You can take a break.\n\nPHASE 2\n\nIn this part of the experiment, you will be presented with a series of images, folowed by a question for the same. Some of the images might have the objects hidden in the image as asked in the question and some might not. In this phase as well you will be under a time limt of 15 seconds. Answer truthfully and honestly. To begin phase 2, press the 'Spacebar'\n\nBEST OF LUCK!",
        font='Arial',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_6 = visual.TextStim(win=win, name='text_6',
        text="Press 'y' if the object was present and 'n' if the object was not present",
        font='Arial',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('instruction_1.started', globalClock.getTime(format='float'))
    # create starting attributes for key_resp_3
    key_resp_3.keys = []
    key_resp_3.rt = []
    _key_resp_3_allKeys = []
    # keep track of which components have finished
    instruction_1Components = [text_3, key_resp_3]
    ...
    for thisComponent in instruction_1Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('instruction_1.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    trials = data.TrialHandler(nReps=1.0, method='sequential', 
        ...
        trialList=data.importConditions('condition for spot the difference.xlsx'),
    ...
    for thisTrial in trials:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('phase_1.started', globalClock.getTime(format='float'))
        ...
        _key_resp_2_allKeys = []
        # keep track of which components have finished
        phase_1Components = [image, text_2, key_resp_2]
        ...
        while continueRoutine:
            ...
            if image.status == STARTED:
                ...
                if tThisFlipGlobal > image.tStartRefresh + 15.0-frameTolerance:
            ...
            if key_resp_2.status == NOT_STARTED and tThisFlip >= 15.0-frameTolerance:
                # keep track of start time/frame for later
        ...
        for thisComponent in phase_1Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('phase_1.stopped', globalClock.getTime(format='float'))
        # check responses
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('instruction_2.started', globalClock.getTime(format='float'))
    # create starting attributes for key_resp_4
    key_resp_4.keys = []
    key_resp_4.rt = []
    _key_resp_4_allKeys = []
    # keep track of which components have finished
    instruction_2Components = [text_4, key_resp_4]
    ...
    for thisComponent in instruction_2Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('instruction_2.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('condition for hidden object.xlsx'),
    ...
    for thisTrial_2 in trials_2:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('phase_2.started', globalClock.getTime(format='float'))
        ...
        _key_resp_5_allKeys = []
        # keep track of which components have finished
        phase_2Components = [image_2, text_6, key_resp_5]
        ...
        while continueRoutine:
            ...
            if text_6.status == NOT_STARTED and tThisFlip >= 20-frameTolerance:
                # keep track of start time/frame for later
            ...
            if key_resp_5.status == NOT_STARTED and tThisFlip >= 20.0-frameTolerance:
                # keep track of start time/frame for later
            ...
            if key_resp_5.status == STARTED and not waitOnFlip:
                ...
                if len(_key_resp_5_allKeys):
                    ...
                    # was this correct?
                    if (key_resp_5.keys == str(Corr_resp)) or (key_resp_5.keys == Corr_resp):
                        key_resp_5.corr = 1
                    else:
                        key_resp_5.corr = 0
                    # a response ends the routine
        ...
        for thisComponent in phase_2Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('phase_2.stopped', globalClock.getTime(format='float'))
        # check responses
